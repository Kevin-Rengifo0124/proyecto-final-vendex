 ...
 * Use the [FragmentCategoriasVendedor.newInstance] factory method to
...
class FragmentCategoriasVendedor : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentCategoriasVendedor.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentCategoriasVendedor().apply {
